...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    size_t page_size=getpagesize(); //functia returneaza nr de bytes al unei pagini, unde pagina este o dimensiune fixa, 
    //unitatea de masura folosita de mmap pt alocari de memorie sau pt file mapping
